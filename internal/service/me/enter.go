...
var (
	...
	ErrProviderAlreadyBound          = errors.New("provider already bound")
	...
	ErrCannotRemoveCurrentDevice     = errors.New("cannot remove current device")
	ErrCurrentUserNotAuthenticated   = errors.New("user not authenticated")
	ErrLoginMethodBindingUnavailable = errors.New("self-service login-method binding is not available yet")
	ErrLoginMethodInputInvalid       = errors.New("invalid provider data")
